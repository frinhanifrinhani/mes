...
class ParticipantePorProjetoController extends AbstractActionController {

    protected $participanteTable;
    protected $participantePorProjetoTable;
...
//    }
    public function listarAction(){
        ...
        $participante = $this->getParticipantePorProjetoTable()->fetchAll($codProjeto);
...
//
    ...
    public function getParticipantePorProjetoTable() {
        if (!$this->participantePorProjetoTable) {
            $sm = $this->getServiceLocator();
            $this->participantePorProjetoTable = $sm->get('Application\Model\ParticipantePorProjetoTable');
        }
        return $this->participantePorProjetoTable;
    }
