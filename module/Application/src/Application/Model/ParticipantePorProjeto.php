...
class ParticipantePorProjeto implements InputFilterAwareInterface {

    public $codParticipantePt;
...
//    protected $inputFilter;
    ...
    function exchangeArray($data) {
        $this->codParticipantePt = (isset($data['cod_participante_pt'])) ? $data['cod_participante_pt'] : null;
    ...
    public function getArrayCopy() {
        return array(
            'cod_participante_pt' => $this->codParticipantePt,
